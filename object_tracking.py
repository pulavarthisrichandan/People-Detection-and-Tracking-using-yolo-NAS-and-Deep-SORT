...
flags.DEFINE_string('model', 'yolo_nas_l', 'yolo_nas_l or yolo_nas_m or yolo_nas_s or yolo_v5 or yolo_v6 or yolo_v7 or yolo_v8')
...
def main(_argv):
    ...
    video_cap = cv2.VideoCapture(int(FLAGS.video) if FLAGS.video.isdigit() else FLAGS.video)
